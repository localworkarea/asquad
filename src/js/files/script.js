...
const focusText = new SplitType('.focus__text', { types: 'lines'});
const animTextTop = new SplitType('.anim-text-top', { types: 'lines'});
const animTextBtm = new SplitType('.anim-text-btm', { types: 'lines'});
const manageBlockText = new SplitType('.manage__block-inf-txt-tablet', { types: 'lines'});
const optionsBlockText = new SplitType('.options__block-inf-txt', { types: 'lines'});
            ...
            _createClass(Iti, [ {
                ...
                value: function _bindDropdownListeners() {
                    ...
                    this._handleClickOffToClose = function(e) {
                        if (!isOpening && e.target.id != 'intlTel-search') {
							//console.log(e);
                    ...
                    this._handleKeydownOnDropdown = function(e) {
                        ...
                        if (e.key === "ArrowUp" || e.key === "Up" || e.key === "ArrowDown" || e.key === "Down") {
                            ...
                            _this9._closeDropdown();
                        }else if(e.target.id == 'intlTel-search'){
							//console.log(e.target.value);
							 _this9._searchForCountry(e.target.value);
						}
...
input.addEventListener("countrychange", function() {
	...
	var im = new Inputmask({alias: 'phone', mask: mask});
	im.mask(input);
});
...
//     console.log("header добавил hidden");
//   } else {
//     header.classList.remove('head-hidden');
//     console.log("header удалил hidden");
//   }
// }
